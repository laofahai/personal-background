...
This repository contains a unified, local-first, markdown-based personal background profile. Any AI agent that reads this file should know how to use the personal context stored here.

## What is this repository?

This is the user's personal background knowledge base. It is meant to be referenced by AI agents across projects to make better decisions, avoid repeated questions, and maintain continuity.
