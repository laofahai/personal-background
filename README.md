...
├── LICENSE
│
├── AGENTS.md               # Cross-agent entry point (generated by bootstrap from kit/templates/AGENTS.md; user-owned)
...
- `AGENTS.md` (generated by bootstrap from `kit/templates/AGENTS.md`; safe to edit)
