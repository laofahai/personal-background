...
Guide the user through completing or updating their personal background repository. This skill is conversational and iterative: it asks targeted questions, then updates files based on the user's answers.
